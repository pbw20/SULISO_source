...
C
C     Calculates natural logarithms of isotopic partition function
C     ratios for species with up to 1000 atoms
C
C     IAN H. WILLIAMS, Department of Chemistry, University of Bath
C
C     version 1.8: 13 May 2016
C
...
C
  ...
  200 FORMAT(20('*'),' LIPFR: 13 May 2016 ',20('*'))
