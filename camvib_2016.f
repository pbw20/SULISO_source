...
C     FREQUENCIES FOR MOLECULES WITH UP TO 1000 ATOMS (SET BY CAM_SIZE);
C     ENABLES TRANSFORMATION OF CARTESIAN FORCE CONSTANTS TO INTERNAL OR 
C     SYMMETRY FORCE CONSTANTS;
C     ALLOWS COMPLIANCE CONSTANTS, RELAXED FORCE CONSTANTS AND
C     INTERACTION DISPLACEMENT COORDINATES TO BE COMPUTED.
C
C     THIS VERSION: OCTOBER 2016
C
...
C             : GAMESS COORDINATES & FORCE CONSTANTS READS FROM .DAT FILE
C               (UNIT 9)
...
C     WRITE(6,202) OMEGA
  ...
  100 FORMAT(1A3)
  101 FORMAT(16(A4,1X))
  200 FORMAT(1X,25('*'),' CAMVIB : Version October 16 ',
     * 25('*')//)
...
C
      READ(IR,107) IA,IFK,(X(J,N),J=1,3),WT(N)
